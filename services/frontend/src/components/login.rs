        ...
        div { class: "min-h-screen flex items-center justify-center",
            div { class: "bg-base-200 p-8 rounded-lg shadow-lg max-w-md w-full",
                    ...
                    button {
                        class: "btn btn-outline btn-primary w-full flex items-center justify-center gap-2",
                            svg {
                                ...
                                class: "flex-grow-0 flex-shrink-0 fill-black dark:fill-white",
                                path {
                ...
                form { action: "#", method: "POST",
                    div { class: "space-y-4",
                        div {
                            label { r#for: "email", class: "sr-only", "Email address" }
                            input {
                                r#type: "email",
                        ...
                        button { r#type: "submit", class: "btn btn-primary w-full",
                            "\n          Log In\n        "
                        }
                    }
                }
