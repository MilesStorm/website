                        ...
                        match &(v.read().command_result) {
                            Some(ice) => rsx! {
                                match &ice {
                                    ...
                                    CommandResult::FailedToStop | CommandResult::Stopped | CommandResult::Timeout | CommandResult::Started | CommandResult::AlreadyRunning | CommandResult::FailedToStart | CommandResult::NumPlayers(_) => {
                                        rsx!{
                                            div {
                                                class: "tooltip tooltip-open tooltip-error",
                        ...
                        match &(v.read().command_result) {
                            Some(ice) => rsx! {
                                match &ice {
                                    ...
                                    CommandResult::Restarting | CommandResult::FailedToStop | CommandResult::Timeout | CommandResult::Started | CommandResult::AlreadyRunning | CommandResult::FailedToStart | CommandResult::NumPlayers(_)=> {
                                        rsx!{
                                            div {
                                                class: "tooltip tooltip-open tooltip-error",
                                                "data-tip": "FailedToStop",
                        ...
                        match &(v.read().command_result) {
                            Some(ice) => rsx! {
                                match &ice {
                                    ...
                                    CommandResult::Restarting | CommandResult::FailedToStop | CommandResult::Timeout | CommandResult::Stopped | CommandResult::FailedToStart | CommandResult::AlreadyStopped | CommandResult::NumPlayers(_)=> {
                                        rsx!{
                                            div {
                                                class: "tooltip tooltip-open tooltip-error",
                                                "data-tip": "FailedToStop",
